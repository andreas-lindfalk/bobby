...
- **Models:** Claude Opus 4.5 / Gemini 2.5 Pro for reasoning; Gemini 2.5 Flash for ingestion/summarization.
...
- **Layer 2:** Autonomous Scout (Agentic RAG): An automated Go-based pipeline that monitors a curated list of "Master Sources" (Official bulletins, local news).
  - **Logic:** Periodically scrape, summarize with Gemini 2.5 Flash, and upsert to Vector DB.
